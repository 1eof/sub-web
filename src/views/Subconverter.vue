  ...
  data() {
    return {
      ...
      options: {
        ...
        backendOptions: [{ value: "https://suc.ly7ngf.top/sub?" }],
        remoteConfig: [
          {
            label: "universal",
            options: [
            ...
            options: [
              {
                label: "1eof",
                value:
                  "https://gist.githubusercontent.com/1eof/2f51d4c41e28199e4d2a8799049f055e/raw/c78d69ec7a5ede7c26642f5603abf950de553328/subconverter.ini"
              },             
              {
                label: "Maying",
                value:
